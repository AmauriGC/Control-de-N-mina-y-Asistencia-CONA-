...
import {getAuth, getRedirectResult, GoogleAuthProvider, signInWithRedirect, signInWithPopup, signOut} from "firebase/auth";
...
export {auth, provider, signInWithRedirect, signInWithPopup, getRedirectResult, signOut};
