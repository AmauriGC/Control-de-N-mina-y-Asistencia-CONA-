...
import {Calendar, ClipboardList, Clock, FileText, Lock, LogOut, Menu, Settings, Users} from "lucide-react";
    ...
    return (
        <div className="flex h-screen w-screen">
            ...
            <main className="flex-1 min-h-screen overflow-y-auto bg-background">
                {/* Mobile top bar */}
                <div
                    className="md:hidden sticky top-0 z-20 bg-background border-b border-border px-3 py-2 flex items-center justify-between">
            ...
            <Logo imgClassName="w-5 h-5 object-contain rounded-sm ring-1 ring-border"/>
            Sistema RH
          </span>
                    <span className="w-9"/>
                </div>
